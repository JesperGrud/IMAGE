...
pheatmap(Data[ (Data$Subsystem == "Cholesterol metabolism" | Data$Subsystem == "Squalene and cholesterol synthesis") & Data$Max >= 1e-04 & Data$Confidence.Level > 0,c(12,13,7:11)], cluster_cols = F, scale="row")
```
